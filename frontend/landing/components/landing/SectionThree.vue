    ...
    >
      ...
      >
        <div>
          ...
          <h3 class="mb-2 text-2xl font-bold dark:text-white">99.99%</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-2xl font-bold dark:text-white">600M+</h3>
          <p class="font-light text-gray-500 dark:text-gray-400">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          </p>
        </div>
        <div>
          ...
          <h3 class="mb-2 text-2xl font-bold dark:text-white">100+</h3>
          <p class="font-light text-gray-500 dark:text-gray-400">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          </p>
        </div>
        <div>
          ...
          <h3 class="mb-2 text-2xl font-bold dark:text-white">5+</h3>
          <p class="font-light text-gray-500 dark:text-gray-400">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
          </p>
        </div>
